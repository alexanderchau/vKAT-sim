  ...
  return (
    <div className="space-y-5">
      ...
      <div className="metric-panel">
        <div className="stat-label mb-1">Estimated vKAT Staking APY</div>
      ...
      <div className="notice-panel">
        ...
        <p className="text-xs mt-3" style={{ color: 'var(--text-muted)' }}>
          Use the {CONSTANTS.COOLDOWN_DAYS}-day cooldown period to reduce exit fee to 2.5%
        </p>
      </div>
      ...
      <div className="info-panel">
        <div className="flex justify-between items-center">
          <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Yield per vKAT (annual)</span>
